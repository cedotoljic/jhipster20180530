...
public class Jhipster20180530App {

    private static final Logger log = LoggerFactory.getLogger(Jhipster20180530App.class);

    private final Environment env;

    public Jhipster20180530App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipster20180530.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jhipster20180530App.class);
